...
\restrict id4KGa5t0MzotPxYtNOm8UeYvQ87RGxpcn4Ugo5eaAAX54GaOoMHyaq5KQnuamQ
...
ALTER TYPE public."ChatRole" OWNER TO workflow_user;
...
ALTER TYPE public."CompactionStatus" OWNER TO workflow_user;
...
ALTER TYPE public."ConversationChannel" OWNER TO workflow_user;
...
ALTER TYPE public."ConversationStatus" OWNER TO workflow_user;
...
ALTER TYPE public."DangerLevel" OWNER TO workflow_user;
...
ALTER TYPE public."ExecutionStatus" OWNER TO workflow_user;
...
ALTER TYPE public."InvoiceStatus" OWNER TO workflow_user;
...
ALTER TYPE public."InvoiceType" OWNER TO workflow_user;
...
ALTER TYPE public."MessageAttachmentStatus" OWNER TO workflow_user;
...
ALTER TYPE public."MessageAttachmentType" OWNER TO workflow_user;
...
ALTER TYPE public."MessageFeedback" OWNER TO workflow_user;
...
ALTER TYPE public."ModelTier" OWNER TO workflow_user;
...
ALTER TYPE public."SubscriptionPlan" OWNER TO workflow_user;
...
ALTER TYPE public."SubscriptionStatus" OWNER TO workflow_user;
...
ALTER TYPE public."ToolConnectionStatus" OWNER TO workflow_user;
...
ALTER TYPE public."TransactionType" OWNER TO workflow_user;
...
ALTER TYPE public."TriggerType" OWNER TO workflow_user;
...
ALTER TYPE public."UserRole" OWNER TO workflow_user;
...
ALTER TYPE public."WhatsAppConnectionStatus" OWNER TO workflow_user;
...
ALTER TYPE public."WorkflowCategory" OWNER TO workflow_user;
...
ALTER TABLE public."_TagToWorkflow" OWNER TO workflow_user;
...
ALTER TABLE public."_WorkflowToTenantTool" OWNER TO workflow_user;
...
ALTER TABLE public._prisma_migrations OWNER TO workflow_user;
...
ALTER TABLE public.api_keys OWNER TO workflow_user;
...
ALTER TABLE public.audit_logs OWNER TO workflow_user;
...
ALTER TABLE public.conversation_compactions OWNER TO workflow_user;
...
ALTER TABLE public.conversations OWNER TO workflow_user;
...
ALTER TABLE public.credit_balances OWNER TO workflow_user;
...
ALTER TABLE public.credit_transactions OWNER TO workflow_user;
...
ALTER TABLE public.end_users OWNER TO workflow_user;
...
ALTER TABLE public.executions OWNER TO workflow_user;
...
ALTER TABLE public.invoices OWNER TO workflow_user;
...
ALTER TABLE public.llm_model_categories OWNER TO workflow_user;
...
ALTER TABLE public.llm_models OWNER TO workflow_user;
...
ALTER TABLE public.message_attachments OWNER TO workflow_user;
...
ALTER TABLE public.messages OWNER TO workflow_user;
...
ALTER TABLE public.notifications OWNER TO workflow_user;
...
ALTER TABLE public.organizations OWNER TO workflow_user;
...
ALTER TABLE public.processed_webhook_events OWNER TO workflow_user;
...
ALTER TABLE public.refresh_tokens OWNER TO workflow_user;
...
ALTER TABLE public.subscriptions OWNER TO workflow_user;
...
ALTER TABLE public.tags OWNER TO workflow_user;
...
ALTER TABLE public.tenant_tool_credentials OWNER TO workflow_user;
...
ALTER TABLE public.tenant_tools OWNER TO workflow_user;
...
ALTER TABLE public.tool_catalog OWNER TO workflow_user;
...
ALTER TABLE public.tool_functions OWNER TO workflow_user;
...
ALTER TABLE public.user_notifications OWNER TO workflow_user;
...
ALTER TABLE public.user_verifications OWNER TO workflow_user;
...
ALTER TABLE public.users OWNER TO workflow_user;
...
ALTER TABLE public.whatsapp_configs OWNER TO workflow_user;
...
ALTER TABLE public.whatsapp_templates OWNER TO workflow_user;
...
ALTER TABLE public.workflow_cron_triggers OWNER TO workflow_user;
...
ALTER TABLE public.workflows OWNER TO workflow_user;
...
\unrestrict id4KGa5t0MzotPxYtNOm8UeYvQ87RGxpcn4Ugo5eaAAX54GaOoMHyaq5KQnuamQ
