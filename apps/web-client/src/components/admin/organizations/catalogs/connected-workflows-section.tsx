  ...
  return (
    <section className="space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-sm font-semibold text-text-primary">Workflows conectados</h3>
        <button
          type="button"
      ...
      {workflows.length > 0 ? (
        ...
        <p className="text-sm text-text-secondary">Ningún workflow consulta este catálogo todavía.</p>
      )}
