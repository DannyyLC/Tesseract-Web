...
class NotificationsApi {
  ...
  public async getNotifications(
    ...
    const result = await this.apiRequestManager.get<ApiResponse<PaginatedResponse<NotificationEventDto>>>(
  ...
  public async markAllAsRead(): Promise<void> {
    await this.apiRequestManager.patch<void>(
      `${NotificationsApi.BASE_URL}/read-all`,
      {}
    );
  }
  ...
  public async deleteNotification(notificationId: string): Promise<void> {
    await this.apiRequestManager.delete<void>(
