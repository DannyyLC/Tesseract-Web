  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      <button
        ...
        className={`flex w-full items-center justify-between rounded-full bg-surface-secondary px-4 py-2 text-sm transition-all duration-200 hover:bg-surface-elevated ${
        ...
        <div className="flex items-center gap-2 pl-2">
          {value && (
            <div
              ...
              className="rounded-full p-0.5 text-text-tertiary transition-colors hover:bg-surface-secondary"
            >
              <X size={14} />
            </div>
          )}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute left-0 right-0 top-full z-50 mt-1 overflow-hidden rounded-xl border border-border bg-surface-panel shadow-lg"
          >
