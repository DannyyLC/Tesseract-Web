      ...
      <div className="relative z-10 flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${allowOverages ? 'translate-x-6' : 'translate-x-1'}`}
              />
            </button>
            <div className="flex flex-col">
              <span className="text-sm font-medium text-white/90 dark:text-black/90">
                Permitir Excedentes
              </span>
              <span className="text-xs text-white/50 dark:text-black/50">
                {allowOverages
                  ? 'El consumo extra se cobrará automáticamente.'
