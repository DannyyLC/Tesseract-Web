...
import { DEFAULT_PAGE_SIZE, DatasetField, DatasetSearchRequest } from '@tesseract/types';
...
export function useDatasetRecords(id: string, limit = DEFAULT_PAGE_SIZE, offset = 0, query = '') {
  return useQuery({
