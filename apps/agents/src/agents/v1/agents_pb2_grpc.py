...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in agents/v1/agents_pb2_grpc.py depends on'
...
class AgentsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Execute = channel.unary_unary(
                '/tesseract.agents.v1.AgentsService/Execute',
                request_serializer=agents_dot_v1_dot_agents__pb2.AgentExecutionRequest.SerializeToString,
                response_deserializer=agents_dot_v1_dot_agents__pb2.AgentExecutionResponse.FromString,
...
def add_AgentsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Execute': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=agents_dot_v1_dot_agents__pb2.AgentExecutionResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'tesseract.agents.v1.AgentsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('tesseract.agents.v1.AgentsService', rpc_method_handlers)
...
class AgentsService(object):
    ...
    def Execute(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            agents_dot_v1_dot_agents__pb2.AgentExecutionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
